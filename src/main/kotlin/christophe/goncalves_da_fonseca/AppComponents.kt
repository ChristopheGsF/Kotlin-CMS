...
import christophe.goncalves_da_fonseca.cms.control.*
...
class AppComponents(val mySqlUrl: String, val mySqlUser: String, val mySqlPassword: String) {
    ...
    fun createComment(view: CommentPresenter.View): CommentPresenter {
        return CommentPresenterImpl(getModel(), view)
    }

    fun login(view: UserPresenter.View): UserPresenter{
